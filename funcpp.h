...
public:
    ...
    {
        struct enable_smart_ptr : public Number {
            enable_smart_ptr(int value)
                : Number(value) {};
        };

        return std::make_shared<enable_smart_ptr>(value);
    }
...
public:
    ...
    {
        struct enable_smart_ptr : public List {
            enable_smart_ptr(const std::vector<int>& elements)
                : List(elements) {};
        };

        return std::make_shared<enable_smart_ptr>(elements);
    }

    static Var list(const std::vector<std::shared_ptr<Variable>>& elements)
    {
        struct enable_smart_ptr : public List {
            enable_smart_ptr(const std::vector<std::shared_ptr<Variable>>& elements)
                : List(elements) {};
        };
    ...
    {
        struct enable_smart_ptr : public List {
            enable_smart_ptr(Var& v)
                : List(v) {};
        };

        return std::make_shared<enable_smart_ptr>(v);
    }

    static Var list(int start, int end)
    {
        struct enable_smart_ptr : public List {
            enable_smart_ptr(int start, int end)
                : List(start, end) {};
        };

        return std::make_shared<enable_smart_ptr>(start, end);
    }
    ...
    static Var empty()
    {
        ...
        return std::make_shared<enable_smart_ptr>(std::vector<std::shared_ptr<Variable>>({}));
    }
...
private:
    List(const std::vector<int>& elements)
        : Variable(Type::List)
    {
        add_elements(elements);
    };

    List(const std::vector<std::shared_ptr<Variable>>& elements)
        : Variable(Type::List)
    {
        add_elements(elements);
    };
